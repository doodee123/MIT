...
#            print l, 'is worth ', SCRABBLE_LETTER_VALUES[l], 'and so your new score is ', wordscore
...
#    print 'The hand is ', hand
    newword = get_frequency_dict(word)
    newhand = {}
    for key, letter in hand.items():
        newhand[key] = letter - newword.get(key,0)
    hand = newhand
#    display_hand(hand)
    return hand         
#
    ...
    while calculate_handlen(hand) > 0:
        ...
        if word == '.':
            ...
            if not is_valid_word(word, hand, word_list):
                ...
                sumwordscore = sumwordscore + get_word_score(word, HAND_SIZE)
                print '"'+ word +'"', 'earned', wordscore, 'points.', 'Total:', sumwordscore, 'points.'
                hand = update_hand(hand, word)

    print 'Total: ', sumwordscore, 'points'
    play_game(word_list)
